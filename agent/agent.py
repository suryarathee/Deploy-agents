...
from .sub_agents.rag_analyst.agent import rag_analyst_agent
...
root_agent = LlmAgent(
    ...
    description=(
        ...
        "execution plans, and evaluate the overall risk. Consults the rag "
        "analyst for historical investing wisdom."
    ),
    ...
    tools=[
        ...
        AgentTool(agent=rag_analyst_agent),
    ],
)